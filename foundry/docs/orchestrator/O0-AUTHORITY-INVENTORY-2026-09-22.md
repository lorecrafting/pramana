...
| U9 | §4 PM work owner | Objective-scoped in the kernel, ticket-scoped in the protected layer | Construct a PM `create_effect` against the protected layer and see whether an objective-scoped PM effect is admissible. This inventory ran no code |

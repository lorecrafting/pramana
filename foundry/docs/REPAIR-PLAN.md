...
| FR-18A | Supply minimal canonical observations, identities, unknowns and failure visibility | FR-08A | **In progress: observation corrections independently passed; bounded protected query is now implementation-ready against the integrated atomic core** | F17, F18 |

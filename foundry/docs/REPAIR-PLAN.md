...
| FR-08B | Migrate every command ingress to one live/replay reducer | FR-08A | **Blocked: first FR-08A atomic-handoff candidate received Astra-high BLOCKER review; bounded correction in progress** | F07, F16 |

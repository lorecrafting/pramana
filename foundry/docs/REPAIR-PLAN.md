...
| FR-08B | Migrate every command ingress to one live/replay reducer | FR-08A | **Blocked: focused source review found the accepted interface cannot atomically compose protected settlement with domain transitions; bounded FR-08A handoff correction in progress** | F07, F16 |
...
| FR-18A | Supply minimal canonical observations, identities, unknowns and failure visibility | FR-08A | **In progress: frozen candidate received independent BLOCKER review; observation corrections underway and bounded protected query serialized behind the active FR-08A core writer** | F17, F18 |

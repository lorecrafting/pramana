...
| Inspect the frozen FR-18A observation/query candidate | [FR-18A candidate and evidence](fr-18a/candidate.md), then its [independent BLOCKER review](fr-18a/independent-review.md), the governing FR-18A criteria and accepted FR-08A combined review; this candidate enables no producer, activation or deployment |

...
| Inspect the frozen FR-18A observation/query candidate | [FR-18A candidate and evidence](fr-18a/candidate.md), its [independent BLOCKER review](fr-18a/independent-review.md), [narrow correction rereview](fr-18a/correction-rereview.md) and [final residual-B1 PASS](fr-18a/final-b1-rereview.md), then the governing FR-18A criteria and accepted FR-08A combined review; B5 remains blocking and this candidate enables no producer, activation or deployment |

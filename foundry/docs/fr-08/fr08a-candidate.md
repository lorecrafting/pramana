...
families and the independent rereview's R1–R6 blocker families. This candidate implements
...
- Rereview-corrected protected core subject: `066e29e1b50535759730b64583876b466629195b`,
...
`1fae01a518c97149894018eb430abdd299111245f5f43a7f3b5ccb802da680be`.
...
Ledger authorization is bounded by its authenticated creation result, and immutable
effect issuer, assignment, request and admission fields are reconstructed from the
originating authenticated command rather than trusted from mutually consistent rows.
...
maintained wrapper executes all 15 independently authored rereview probes, covering
semantic-rejection rollback, derived phase/ordinal/policy identity, predecessor fencing,
authenticated recovery provenance, receipt observation collision and mixed-subtree close.
...
- independently authored rereview probes at seed 9293: 15 passed;
- native xSync fixture after its bounded dependency-path correction: 2 passed;
- full model-free suite at seed 9293: 572 passed, 1 optional Python/tiktoken recomputation
  excluded;
- canonical `ci/run.exs`: exit 0, 572 passed, 1 optional recomputation excluded; dependency
  ...
  Provenance SHA-256:
  `239056451fe00d688b507644da12f8583fb238fc545e0954fd7003c79bf561db`.
...
```text
1fae01a518c97149894018eb430abdd299111245f5f43a7f3b5ccb802da680be  foundry/docs/fr-08/fr08a-protected-report.txt
...
9e5dc8e8d3e132008871c546e145ad67d77ae2ee144dd28fac5ab553651eeab0  foundry/lib/pramana_foundry/durable_store/protected_primitives.ex
8169d4630cf9ebcadd51a4a174c5c079fa6d6a0de4ce5e600bf8eafabf323cea  foundry/lib/pramana_foundry/repair/fr08a_protected_boundary.ex
...
1fa7bafb765e49515ba55e2481e80d0bbd2e13cf921efb0d0894c3d121628230  foundry/test/pramana_foundry/durable_store/fr08a_rereview_matrix_test.exs
...
1c1deaf635b03c64c0a8eb2572160badff07ab71a95fe9ab9d0da3998ed626c9  foundry/test/pramana_foundry/repair/fr08a_protected_boundary_test.exs

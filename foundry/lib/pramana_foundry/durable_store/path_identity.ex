defmodule PramanaFoundry.DurableStore.PathIdentity do
  ...
  defp regular_single_link(%{type: type}) when type != :regular, do: {:error, :database_not_regular}
  defp regular_single_link(%{links: 1}), do: :ok
  defp regular_single_link(%{links: links}) when links > 1, do: {:error, :database_hardlink_not_allowed}

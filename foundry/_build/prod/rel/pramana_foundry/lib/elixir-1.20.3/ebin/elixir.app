    ...
    [{description,"elixir"},
     ...
     {modules,
         ['Elixir.Access','Elixir.Agent.Server','Elixir.Agent',
          ...
          'Elixir.BadMapError','Elixir.Base','Elixir.Behaviour',
          'Elixir.Bitwise','Elixir.Calendar.ISO',
          ...
          'Elixir.Module.Types.Traverse','Elixir.Module.Types',
          ...
          elixir_lexical,elixir_map,elixir_module,elixir_overridable,
          elixir_parser,elixir_quote,elixir_rewrite,elixir_sup,
          elixir_tokenizer,elixir_utils,iex]},

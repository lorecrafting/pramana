defmodule PramanaFoundry.DurableStore.FR08ARereviewMatrixTest do
  ...
  @tag timeout: 120_000
  test "the maintained hostile rereview matrix passes all fifteen public cases" do
    foundry_root = Path.expand("../../..", __DIR__)
    probe = Path.join(foundry_root, "docs/fr-08/fr08a-rereview-probes.exs")
    ...
    assert output =~ "Result: 15 passed", output
  end

# Pramāṇa project route

Follow the shared [repository instructions](../AGENTS.md) and
[workflow](../docs/agents/WORKFLOW.md). This directory is the Pramāṇa Mix umbrella;
run its Mix, asset, native and corpus commands here, not at the Git root.

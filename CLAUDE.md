...
| `docs/RULES.md` | **59 rules** from real defects, cited by number — read before a new pipeline |
...
`docs/RULES.md` holds **59 rules, each learned from a real defect here**, and they are cited

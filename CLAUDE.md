...
| `docs/RULES.md` | **65 rules** from real defects, cited by number — read before a new pipeline |
...
`docs/RULES.md` holds **65 rules, each learned from a real defect here**, and they are cited

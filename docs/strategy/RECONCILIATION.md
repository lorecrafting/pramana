...
| 10. Six-layer agent OS | Use one review vocabulary and existing repair interfaces; correct the efficiency metric. [Foundry](FOUNDRY.md), [Validation](VALIDATION.md) |
| 11. Shared four-level memory | Preserve selective context, reject shared Foundry/corpus infrastructure. [Foundry](FOUNDRY.md#memory-evidence-first-projections-second), I-P5 |
...
| 13. Mem0/native memory fusion | Retain attributable records and retrieval experiments; reject proposed Foundry `Pramana.Repo`/pgvector coupling and default-verified facts. [Research](RESEARCH.md), [Foundry](FOUNDRY.md) |
| 14. Two independent brains | Make the independence authoritative; replace zero-dependency/latency claims with actual repair contracts. [Foundry](FOUNDRY.md#mission-and-boundary) |
| 15. Event sourcing/read-time compilation | Resolve the summary contradiction: retain required evidence, allow replaceable projections, enforce privacy/retention. [Foundry](FOUNDRY.md#memory-evidence-first-projections-second) |
...
| 17. QM/multiplayer | Separate security from sharing; retain scoped promotion, defer collaboration until real demand. [Research](RESEARCH.md#engineering-sources), I-P7 |
| 18. Loop bounds/coordination | Reuse repaired ledger/lifecycle; distinguish healthy idle from productive success; allow safe non-success stops. [Foundry](FOUNDRY.md#providers-budgets-and-recovery) |

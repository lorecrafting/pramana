...
**Checked:** 2026-09-15. This register distinguishes source evidence from our
...
| E19 | [DILA Glossaries for Buddhist Studies](https://glossaries.dila.edu.tw/), checked 2026-09-17 | The glossary portal states CC BY-NC-SA 4.0 for its content and exposes Soothill-Hodous, Karashima and multilingual Buddhist term resources. Individual digital works may carry more specific notices; use the reviewed per-glossary record, preserve work/translator scope, and do not infer that an English gloss is a universal doctrinal synonym |

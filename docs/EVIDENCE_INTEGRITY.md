...
[Pramāṇa index](README.md) · [MCP](MCP.md) · [Reader](READER.md) · [Testing](TESTING.md)
...
For parser/overlap/output scaling without database or model work, run from the repository root:

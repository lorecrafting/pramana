...
- [`pramana/docs/PLAN_INDEX.md`](../pramana/docs/PLAN_INDEX.md)
...
## Sibling-layout entry points

[Migration and operational handoff](LAYOUT_MIGRATION.md) ·
[Pramāṇa agent route](../pramana/AGENTS.md) · [Foundry agent route](../foundry/AGENTS.md) ·
[Pramāṇa documentation](../pramana/docs/README.md).

Old product-guide paths retained below are compatibility routes only:
...
## Sibling source migration

- [Operator cutover and rollback](LAYOUT_MIGRATION.md)

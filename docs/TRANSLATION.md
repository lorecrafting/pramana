...
[translation design and experiments](records/translation-design-and-experiments.md).
...
| Earlier section |
|---|
| <a id="translation-baked-layers-on-the-fly-and-model-multiplicity"></a>[Translation: Baked Layers, On-the-Fly, and Model Multiplicity](records/translation-design-and-experiments.md#translation-baked-layers-on-the-fly-and-model-multiplicity) |
| <a id="the-reframe"></a>[The reframe](records/translation-design-and-experiments.md#the-reframe) |
| <a id="three-tiers"></a>[Three tiers](records/translation-design-and-experiments.md#three-tiers) |
| <a id="two-purposes-and-the-bar-is-different--decided-2026-09-02"></a>[Two PURPOSES, and the bar is different — decided 2026-09-02](records/translation-design-and-experiments.md#two-purposes-and-the-bar-is-different--decided-2026-09-02) |
| <a id="index-english-does-not-have-to-be-readable-and-may-not-want-to-be-prose"></a>[Index English does not have to be readable, and may not want to be prose](records/translation-design-and-experiments.md#index-english-does-not-have-to-be-readable-and-may-not-want-to-be-prose) |
| <a id="reader-english-is-a-different-obligation"></a>[Reader English is a different obligation](records/translation-design-and-experiments.md#reader-english-is-a-different-obligation) |
| <a id="what-this-system-guarantees-and-what-it-does-not"></a>[What this system guarantees, and what it does not](records/translation-design-and-experiments.md#what-this-system-guarantees-and-what-it-does-not) |
| <a id="the-translation-layer-is-meant-to-be-replaced-and-the-pool-already-allows-it"></a>[The translation layer is meant to be replaced, and the pool already allows it](records/translation-design-and-experiments.md#the-translation-layer-is-meant-to-be-replaced-and-the-pool-already-allows-it) |
| <a id="why-ephemeral-output-does-not-go-straight-into-the-bake"></a>[Why ephemeral output does not go straight into the bake](records/translation-design-and-experiments.md#why-ephemeral-output-does-not-go-straight-into-the-bake) |
| <a id="getting-text-to-a-model-and-back--export--import-built-2026-09-02"></a>[Getting text to a model and back — `export` / `import`, built 2026-09-02](records/translation-design-and-experiments.md#getting-text-to-a-model-and-back--export--import-built-2026-09-02) |
| <a id="the-promotion-pipeline"></a>[The promotion pipeline](records/translation-design-and-experiments.md#the-promotion-pipeline) |
| <a id="divergence-as-a-feature-not-a-problem"></a>[Divergence as a feature, not a problem](records/translation-design-and-experiments.md#divergence-as-a-feature-not-a-problem) |
| <a id="selection-policy-at-the-api"></a>[Selection policy at the API](records/translation-design-and-experiments.md#selection-policy-at-the-api) |
| <a id="cost-and-latency"></a>[Cost and latency](records/translation-design-and-experiments.md#cost-and-latency) |
| <a id="four-levers-and-the-order-to-reach-for-them"></a>[Four levers, and the order to reach for them](records/translation-design-and-experiments.md#four-levers-and-the-order-to-reach-for-them) |
| <a id="the-decoupling-contract-holds"></a>[The decoupling contract holds](records/translation-design-and-experiments.md#the-decoupling-contract-holds) |
| <a id="prior-art-we-already-own"></a>[Prior art we already own](records/translation-design-and-experiments.md#prior-art-we-already-own) |
| <a id="roadmap-placement"></a>[Roadmap placement](records/translation-design-and-experiments.md#roadmap-placement) |

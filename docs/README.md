...
Pramāṇa source and maintained product guides now live under `pramana/`.
See [the migration guide](LAYOUT_MIGRATION.md) for command roots and existing data.
Old root-level product-guide pages are compatibility links, not duplicate policy.
...
| Write code | Applicable [conventions](CODE_CONVENTIONS.md), [language boundaries](../pramana/docs/ELIXIR.md) |
...
[Plan navigation](../pramana/docs/PLAN_INDEX.md) opens specific sections of the unchanged shared
...
[Model-reader alternatives](../pramana/docs/AGENT_MODELS.md), [harness proposals](HARNESS.md),

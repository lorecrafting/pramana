...
| commentary chains | **274 work relations** — 182 `comments_on`, 9 `subcommentary_of`, 82 `parallel_of`. The Tibetan 102 are new 2026-09-02 and are the first non-Chinese links: `toh4210` Pramāṇavārttika ← its vṛttis ← their ṭīkās |
| Tibetan work titles | **3,510 of 4,575** named — the Kangyur's 1,189 from 84000, the Tengyur's 2,675 promoted out of `works.meta` on 2026-09-02. 705 have no title block in the edition |
